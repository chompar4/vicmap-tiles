        ...
        return b.mixin(c.prototype, {
            ...
            _safeSet: function(a, b) {
                try {
                    ...
                    "QuotaExceededError" === a.name && (this.clear(),
                    this._noop())
                }
            },
            get: function(a) {
        ...
        b.mixin(c.prototype, {
            ...
            _get: function(a, b) {
                ...
                function g() {
                    d--,
                    delete f[h],
                    j.onDeckRequestArgs && (j._get.apply(j, j.onDeckRequestArgs),
                    j.onDeckRequestArgs = null)
                }
                var h, i, j = this;
                h = this._fingerprint(a),
                this.cancelled || h !== this.lastReq || ((i = f[h]) ? i.done(c).fail(e) : d < this.maxPendingRequests ? (d++,
                f[h] = this._send(a).done(c).fail(e).always(g)) : this.onDeckRequestArgs = [].slice.call(arguments, 0))
            },
            get: function(c, d) {
                var e, f;
                d = d || a.noop,
      ...
      , h = window.SearchIndex = function() {
        ...
        return b.mixin(c.prototype, {
            ...
            search: function(a) {
                ...
                b.each(c, function(a) {
                    var b, c, d, f;
                    if (e && 0 === e.length && !j.matchAnyQueryToken)
                        return !1;
                    for (b = j.trie,
...
function(a, b) {
    ...
    var b = function() {
      ...
      , d = function() {
        ...
        b.mixin(c.prototype, {
            _trigger: function(b, c) {
                var e = a.Event(d + b);
                return this.$el.trigger.call(this.$el, e, c || []),
                e
            },
            before: function(a) {
                var b, c;
      ...
      , f = function(a) {
        ...
        return function(c) {
            function f(b) {
                var d, e, f;
                return (d = h.exec(b.data)) && (f = a.createElement(c.tagName),
            ...
            var h;
            c = b.mixin({}, e, c),
            c.node && c.pattern && (c.pattern = b.isArray(c.pattern) ? c.pattern : [c.pattern],
      ...
      , h = function() {
        ...
        function c(c, e) {
            ...
            this.$el = a(c.node).attr("role", "presentation").addClass(this.classes.dataset).addClass(this.classes.dataset + "-" + this.name)
        }
        function d(a) {
            function c(b) {
                return b[a]
        ...
        b.mixin(c.prototype, e, {
            ...
            _getSuggestionsFragment: function(c, d) {
                ...
                b.each(d, function(b) {
                    ...
                    d = a(g.templates.suggestion(f)).data(i.dataset, g.name).data(i.obj, b).data(i.val, g.displayFn(b)).addClass(g.classes.suggestion + " " + g.classes.selectable),
                    e.appendChild(d[0])
                }),
                this.highlight && f({
        ...
        return b.mixin(c.prototype, e, {
            ...
            _allDatasetsEmpty: function() {
                return b.every(this.datasets, b.bind(function(a) {
                    var b = a.isEmpty();
                    return this.$node.attr("aria-expanded", !b),
                    b
                }, this))
            },
            ...
            bind: function() {
                var c, d = this;
                return c = b.bind(this._onSelectableClick, this),
      ...
      , j = function() {
        ...
        function c(c) {
            ...
            b.each(c.menu.datasets, b.bind(function(a) {
                a.onSync && (a.onSync("rendered", b.bind(this.update, this)),
      ...
      , l = function() {
        ...
        return b.mixin(c.prototype, {
            ...
            _onEnterKeyed: function(a, b) {
                ...
                b.stopPropagation()) : this.autoselect && this.select(this.menu.getTopSelectable()) && (b.preventDefault(),
                b.stopPropagation())
            },
            ...
            select: function(a) {
                ...
                return !(!b || this.eventBus.before("select", b.obj, b.dataset)) && (this.input.setQuery(b.val, !0),
            ...
            autocomplete: function(a) {
                ...
                c = this.menu.getSelectableData(a),
                d = c && b !== c.val,
                !(!d || this.eventBus.before("autocomplete", c.obj, c.dataset)) && (this.input.setQuery(c.val),
            ...
            moveCursor: function(a) {
                ...
                !g && !this.eventBus.before("cursorchange", e, f) && (this.menu.setCursor(c),
    ...
    !function() {
        ...
        function n(a) {
            ...
            a.removeData(q.typeahead).removeData(q.www).removeData(q.attr).removeClass(c.classes.input),
        ...
        r = {
            initialize: function(e, m) {
                function n() {
                    ...
                    r && r.val(""),
                    c = h(c, p),
                    (t || u) && (n.css(p.css.wrapper),
                    c.css(t ? p.css.input : p.css.inputWithNoHint),
                    c.wrap(n).parent().prepend(t ? r : null).append(u ? s : null)),
                    A = u ? k : i,
                    v = new d({
                        el: c
                    }),
                ...
                var p;
                return m = b.isArray(m) ? m : [].slice.call(arguments, 1),
                e = e || {},
                p = c(e.classNames),
                this.each(n)
            },
